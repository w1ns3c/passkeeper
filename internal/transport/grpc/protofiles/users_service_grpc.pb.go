...
const (
	...
	UserSvc_ChangePass_FullMethodName   = "/UserSvc/ChangePass"
)
...
func (c *userSvcClient) ChangePass(ctx context.Context, in *UserChangePassReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, UserSvc_ChangePass_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserSvcServer) ChangePass(context.Context, *UserChangePassReq) (*empty.Empty, error) {
...
func _UserSvc_ChangePass_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserChangePassReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserSvcServer).ChangePass(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserSvc_ChangePass_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserSvcServer).ChangePass(ctx, req.(*UserChangePassReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserSvc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserSvc_ChangePass_Handler,
		},
	},
